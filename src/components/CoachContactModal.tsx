...
interface CoachContactModalProps {
  isOpen: boolean
  onClose: () => void
}

const CoachContactModal = ({ isOpen, onClose }: CoachContactModalProps) => {
        ...
        >
          ...
          <div className="p-6">
            <p className={`text-center mb-6 ${
              ...
              Elige tu método preferido para contactar al coach
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
              ...
              >
                <svg className="w-8 h-8 mb-2 text-pink-600" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <svg className="w-8 h-8 mb-2 text-gray-900 dark:text-gray-100" fill="currentColor" viewBox="0 0 24 24">
